...
namespace Template.Shared.Interfaces.IServices
{
    ...
    public interface IDalService
    {
        ...
        /// <returns></returns>
        Task<Guid> CreatorManagerAsync(Entity type, object model);
        ...
        /// <returns></returns>
        Task<Guid> UpdateManagerAsync(Entity type, string publicKey, object toUpdate);
        ...
        Task<bool> DeleteManagerAsync(Entity type, string publicKey);
